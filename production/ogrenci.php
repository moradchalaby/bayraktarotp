                  ...
                  <?php 
                    while($ogrencicek=$ogrencisor->fetch(PDO::FETCH_ASSOC)){
                      ...
                      <tr>
                       ...
                       <td><a href="#"  data-toggle="modal" data-target="#<?php echo $ogrencicek['ogrenci_id'] ?>hocadegis" data-whatever="<?php echo $ogrencicek['ogrenci_adsoyad']; ?>"><?php echo $hocacek['kullanici_adsoyad']; ?></a></td>
