 ...
 <div class="right_col" role="main">
     ...
     <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_panel">
                 <div class="x_title">
                     <h2>Tam Liste <small> Ayrılan tüm talebeler.</small>
                ...
                ?>
                       ...
                       <td><a href=" ogrenci-detay.php?ogrenci_id=<?php echo $ogrencicek['ogrenci_id'] ?>"><?php echo $ogrencicek['ogrenci_adsoyad']; ?></a>
                                 ...
                                 <td><a href="#" data-toggle="modal"
                                         ...
                                         data-whatever="<?php echo $ogrencicek['ogrenci_adsoyad']; ?>"><?php echo $hocacek['kullanici_adsoyad']; ?></a>
                                 </td>
                        ...
                        echo $birimcek['birim_ad']; ?></a></td>
                                 ...
                                 <td><a href="ogrenci-duzenle.php?ogrenci_id=<?php echo $ogrencicek['ogrenci_id'] ?>"><button
                                             class="btn btn-primary btn-xs">Düzenle</button></a><button type="submit"
                                         class="btn btn-danger btn-xs" data-toggle="modal"
                                         data-target="#<?php echo $ogrencicek['ogrenci_id'] ?>">Sil</button></td>




                                 <!-- Modal -->
                                 <div class="modal fade" id="<?php echo $ogrencicek['ogrenci_id'] ?>" tabindex="-1"
                                     ...
                                     <div class="modal-dialog" role="document">
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-footer">
                                                 ...
                                                 <a
                                                     href="../netting/islem.php?ogrenci_id=<?php echo $ogrencicek['ogrenci_id'] ?>&ogrencisil=ok"><button
                                                         type="button" class="btn btn-primary">Evet</button> </a>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
