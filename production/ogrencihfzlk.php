                  ...
                  <?php if (intval($sayfa[0]) >= $sayfas) : ?>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><a href="#" data-toggle="modal" data-target="#<?php echo $ogrencicek['ogrenci_id'] ?>dersekle" data-whatever="<?php echo $ogrencicek['ogrenci_adsoyad']; ?>"><?php echo $ogrencicek['ogrenci_adsoyad']; ?></a>
                        </td>
                        <td><a href="#" data-toggle="modal" data-target="#<?php echo $ogrencicek['ogrenci_id'] ?>hocadegis" data-whatever="<?php echo $ogrencicek['ogrenci_adsoyad']; ?>"><?php echo $kullanicicek['kullanici_adsoyad']; ?></a>
                        </td>

                        <td><?php echo $sinifidcek['sinif_ad']; ?></td>
                        <td><a href="#" data-toggle="modal" data-target="#<?php echo $ogrencicek['ogrenci_id']; ?>hafizlikdurum" data-whatever="<?php echo $ogrencicek['ogrenci_adsoyad']; ?>"><?php echo $hafizlikdurumcek['hafizlik_durum']; ?></a>
                        </td>
                        ...
                        ?>
                          <td>
                            <?php while ($hafizlikderscek = $hafizlikderssor->fetch(PDO::FETCH_ASSOC)) { ?><a href="#" data-toggle="modal" data-target="#<?php echo $hafizlikderscek['hafizlik_id']; ?>hocagoster" data-whatever="<?php echo $tarh; ?>"><?php echo $hafizlikderscek['hafizlik_sayfa'] . '/' . $hafizlikderscek['hafizlik_cuz']; ?></a><?php
