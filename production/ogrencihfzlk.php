                ...
                while ($ogrencicek = $ogrencisor->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  $sayfa = explode('/', $hafizlikdurumcek['hafizlik_son']); ?>
                    ...
                    ?>
                            ...
                            <tr>
                                <td> <a href="ogrenci-detay.php?ogrenci_id=<?php echo $ogrencicek['ogrenci_id'] ?>"
                                        class="btn btn-primary btn-xs"> <?php echo $say ?> </a></td>
                                ...
                                <td><a href="#" data-toggle="modal"
                                        data-target="#<?php echo $ogrencicek['ogrenci_id']; ?>hafizlikdurum"
                                        data-whatever="<?php echo $ogrencicek['ogrenci_adsoyad']; ?>"><?php echo $hafizlikdurumcek['hafizlik_durum']; ?></a>
                                </td>
                        ...
                        ?>
                                <td>
                                    <?php while ($hafizlikderscek = $hafizlikderssor->fetch(PDO::FETCH_ASSOC)) { ?>
                                    <a href="#" data-toggle="modal"
                                        data-target="#<?php echo $hafizlikderscek['hafizlik_id']; ?>hocagoster"
                                        data-whatever="<?php echo $tarh; ?>">
                                        <?php echo $hafizlikderscek['hafizlik_sayfa'] . '/' . $hafizlikderscek['hafizlik_cuz']; ?></a><?php
