      <div role="tabpanel" class="tab-pane fade" id="tab_content5" aria-labelledby="profile-tab">
        ...
        <div class="progress progress_md">
          ...
          <div class="progress-bar bg-green" role="progressbar" style="width: <?php echo $tamsinav / $sinavpuankac ;  ?>%" aria-valuenow="<?php echo $tamsinav / $sinavpuankac ; ?>" aria-valuemin="0" aria-valuemax="100">%<?php echo $tamsinav / $sinavpuankac ;  ?></div>
          ...
          <table  class="table table-striped ">
            ...
            <thead>
              ...
              <tr>
                ...
                <th style="text-align: center;"><?php echo $ogrencicek['ogrenci_adsoyad'] ?> <br><span>İmtihan Çetelesi</span></th>
                  ...
                  <li class="list-group-item col-md-6 col-sm-6 col-xs-12">
                    ...
                    while ($sinavcek = $sinavsor->fetch(PDO::FETCH_ASSOC)) { 
                      ...
                      if ($sinavcek['sinav_not']>=60) {
                        ...
                        <button class="btn btn-xs btn-success" title="<?php echo $sinavcek['sinav_ad'] ?>"><?php echo $sinavcek['sinav_not'] ?></button>
                      <?php   } elseif ($sinavcek['sinav_not']=='Not Girilmedi') { ?>

                        <button class="btn btn-xs btn-danger" title="<?php echo $sinavcek['sinav_ad'] ?>">---</button>
                      <?php        } else{ 


                        ?>

                        <button class="btn btn-xs btn-danger" title="<?php echo $sinavcek['sinav_ad'] ?>"><?php echo $sinavcek['sinav_not'] ?>
                      <?php  } ?>
