<div class="modal fade" id="<?php echo $ogrencicek['ogrenci_id']; ?>hocadegis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
            

                <h5 class="modal-title" id="<?php echo $ogrencicek['ogrenci_id'] ?>"> <strong><?php echo $ogrencicek['ogrenci_adsoyad'] ?></strong> İsimli Öğrencinin Hocasını Değiştir</h5>
                ...
                <form action="../netting/islem.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kullanici_id" class="select2_multiple form-control col-md-7 col-xs-12">
                            ...
                            <option value="<?php echo $hocacek['kullanici_id']; ?>"  <?php if ($ogrencicek['kullanici_id'] == $hocacek['kullanici_id']){ echo "selected" ; } ?> ><?php echo $hocacek['kullanici_adsoyad']; ?></option>
                        <?php } 
