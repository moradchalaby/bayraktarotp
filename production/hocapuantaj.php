	...
	<div class=" col-md-12 col-sm-12 col-xs-12" >
		...
		$birimsor->execute(array(
            ...
            while ($birimcek=$birimsor->fetch(PDO::FETCH_ASSOC)) {  ?>
            	...
            	<div class="x_panel <?php  if (!empty($_POST['idm'])) {  echo 'gizle'; } ?>">
            		...
            		<div class="x_content">
            			...
            			<table class="table table-striped projects raportab">
            				...
            				<thead >
            					<tr>
            						<th style="width: 1%" class="hidden-xs gizle"><input type="checkbox" onclick="toggle<?php echo $birimcek['birim_id']; ?>(this);" /></th>
            						<script>
            							function toggle<?php echo $birimcek['birim_id']; ?>(source) {
            								var checkboxes = document.querySelectorAll('input[class="birim<?php echo $birimcek['birim_id']; ?>"]');
            				...
            				<tbody>
                                ...
                                if ($varmis>=1) {
            						...
            						<tr>
            							<td class="gizle hidden-xs "><input type="checkbox"  name="idm[]" class="birim<?php echo $birimcek['birim_id']; ?>" value="<?php echo $hocalarcek['kullanici_id']; ?>"/></td>
            							<td>
            								<!--a href="#" data-toggle="modal" data-target="#<?php echo $hocalarcek['kullanici_id']; ?>dersekle" data-whatever="<?php echo $hocalarcek['kullanici_adsoyad']; ?>"--><?php echo $hocalarcek['kullanici_adsoyad']; ?><!--/a-->
            								<br />
            								...
            								while ($sayfalarcek=$sayfalarsor->fetch(PDO::FETCH_ASSOC)) {
            									...
            									if ($iht[1]) { 
            									    ...
            									    $sayfasayisi = $sayfasayisi+$sayf[0];
            									}
            							...
            							<td class="project_progress  hidden-xs">
            								...
            								<div class="progress progress_sm">
            									...
            									<div class="progress-bar " style="background-color: #30363d !important;"  role="progressbar" data-transitiongoal="<?php echo floatval($sayfamiz[0])*100 / $sayfasayisi; ?>"></div>


            								</div>
            								<small>Başarı: %<?php echo round(floatval($sayfamiz[0])*100 / $sayfasayisi,2); ?> - Örenci Sayfa Sayısı: <?php echo $sayfasayisi; ?> Sayfa - Günlük Saat: <?php echo $sayfasayisi*1.5/60; ?> </small>
            								...
            								<td class="gizle hidden-xs">
            									...
            									<a href="kullanici-duzenle.php?kullanici_id=<?php echo $hocalarcek['kullanici_id'] ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Düzenle </a>
            									<a  class="btn btn-danger btn-xs" data-toggle="modal" data-target="#<?php echo $hocalarcek['kullanici_id']; ?>sil"><i class="fa fa-trash-o"></i> Sil </a>
            								</td>

            								<div class="modal fade" id="<?php echo $hocalarcek['kullanici_id']; ?>sil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            									...
            									<div class="modal-dialog" role="document">
            										<div class="modal-content">
            											...
            											<div class="modal-body">
            												<h3> <strong><?php echo $hocalarcek['kullanici_adsoyad'] ?></strong> İsimli Hocanın Kaydı Siliniyor..</h3>
            											</div>
